...
consumerKey="v4uEd480jfM4vjuykpHOl031O"
consumerSecret="M6pBX00ajp3wRhHSTS7U9wX9nCvLZFULCZeLIg0jses2r1Ffs0"
AccessToken="4060169593-Zd3v5q79GTA0RmmKrv5DUiJaKoTgH7FGAEnyMDq"
AccessTokenSecret="YlafoQChaIxjLXOXvBhymVOtFnJWQZzNzPJzfK217hciv"
...
#for user - 
(tweets = userTimeline("AbhilashaAchar2", n=10))
userTimeline("drisha_sinha", n=5)

#------------------------------------
?userTimeline
tweets = userTimeline("AbhilashaAchar2", n=100)
#english
tweets[1:5]
