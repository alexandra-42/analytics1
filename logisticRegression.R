...
require(caTools)
set.seed(101)
sample=sample.split(mtcars$am, SplitRatio = .75) #mtcars$am determines against which column do we want the split bcz we want equal representation of 0s and 1s in out train and test data
